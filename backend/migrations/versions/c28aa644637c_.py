...
Revision ID: c28aa644637c
Revises: 
Create Date: 2020-05-29 18:10:13.087845
...
def upgrade():
    ...
    sa.Column('modSetting', sa.Integer(), nullable=True),
    ...
    sa.Column('githubLink', sa.String(length=100), nullable=True),
    sa.Column('twitterLink', sa.String(length=100), nullable=True),
    sa.Column('linkedinLink', sa.String(length=100), nullable=True),
    ...
    sa.ForeignKeyConstraint(['followed_by'], ['userprofile.id'], ),
    sa.ForeignKeyConstraint(['follower'], ['userprofile.id'], )
    )
    op.create_table('tag_follower_assoc',
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.Column('follower_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['follower_id'], ['userprofile.id'], ),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], ),
    sa.PrimaryKeyConstraint('tag_id', 'follower_id')
    )
    op.create_table('tag_moderators_assoc',
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.Column('moderator_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['moderator_id'], ['userprofile.id'], ),
    sa.ForeignKeyConstraint(['tag_id'], ['tags.id'], ),
    sa.PrimaryKeyConstraint('tag_id', 'moderator_id')
    )
...
def downgrade():
    ...
    op.drop_table('tag_moderators_assoc')
    op.drop_table('tag_follower_assoc')
